-- Migration: Update Role Models Assessment Questions (Version 2)
-- This migration updates the 11 role models questions with new text and help text

-- Clear existing role models questions
DELETE FROM role_models_questions;

-- Insert updated Role Models Questions with help text
...
('Have you had conversations with any of your role models regarding your career aspirations? If so, what have you discussed?', 'If you have talked to your role model about your career goals or aspirations, describe those conversations. Share what advice, insights, or guidance they provided. If you haven''t had such conversations, you can mention that and explain why.', 6),

-- Question 7: Opinion on Dream Career
('If not, have you thought about getting their opinion on your dream career?', 'If you haven''t discussed your career aspirations with them yet, reflect on whether you would like to seek their opinion or advice. Explain why you think their perspective would be valuable, or why you might be hesitant to ask. Share your thoughts about approaching them for guidance.', 7),
...
BEGIN
    ...
    IF role_models_q_count = 11 THEN
        RAISE NOTICE '✅ All 11 questions inserted successfully!';
    ELSE
        RAISE WARNING '⚠️ Expected 11 questions, found %', role_models_q_count;
    END IF;
END $$;
