-- Migration: Add School Learning Assessment Summary Template
-- This migration adds the AI summary template for the "My School, My Learning and I" assessment to the database

-- Insert School Learning summary template into assessment_summary_templates
...
BEGIN
    ...
    IF school_learning_template_count = 1 THEN
        RAISE NOTICE '✅ School Learning summary template inserted successfully!';
    ELSE
