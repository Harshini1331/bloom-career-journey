-- Migration: Complete Data Population
-- This migration ensures all assessment data is properly populated
...
DO $$
DECLARE
    holland_count INTEGER;
    inspiration_q_count INTEGER;
    inspiration_v_count INTEGER;
    dreams_count INTEGER;
    school_learning_count INTEGER;
    school_options_count INTEGER;
    role_models_count INTEGER;
    hobbies_count INTEGER;
    about_me_count INTEGER;
BEGIN
    SELECT COUNT(*) INTO holland_count FROM holland_code_questions;
    SELECT COUNT(*) INTO inspiration_q_count FROM inspiration_questions;
    SELECT COUNT(*) INTO inspiration_v_count FROM inspiration_videos;
    SELECT COUNT(*) INTO dreams_count FROM dreams_questions;
    SELECT COUNT(*) INTO school_learning_count FROM school_learning_questions;
    SELECT COUNT(*) INTO school_options_count FROM school_learning_options;
    SELECT COUNT(*) INTO role_models_count FROM role_models_questions;
    SELECT COUNT(*) INTO hobbies_count FROM hobbies_questions;
    SELECT COUNT(*) INTO about_me_count FROM about_me_questions;
    
    RAISE NOTICE 'Data Population Complete:';
    RAISE NOTICE 'Holland Code Questions: %', holland_count;
    RAISE NOTICE 'Inspiration Questions: %', inspiration_q_count;
    RAISE NOTICE 'Inspiration Videos: %', inspiration_v_count;
    RAISE NOTICE 'Dreams Questions: %', dreams_count;
    RAISE NOTICE 'School Learning Questions: %', school_learning_count;
    RAISE NOTICE 'School Learning Options: %', school_options_count;
