      ...
      <div className="container mx-auto px-4">
        <TooltipProvider>
          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-col md:flex-row bg-white rounded-lg p-1 shadow-md gap-1 w-full md:w-auto">
              <button
                onClick={() => setCurrentTab('roleModel1')}
                className={`px-3 py-2 rounded-md transition-all text-xs text-center min-w-[140px] ${currentTab === 'roleModel1'
              ...
              <button
                ...
                className={`px-3 py-2 rounded-md transition-all text-xs text-center min-w-[140px] ${currentTab === 'roleModel2'
                    ? 'bg-purple-600 text-white shadow-md'
                    : 'text-gray-600 hover:text-purple-600'
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 py-2 rounded-md transition-all text-xs text-center min-w-[140px] ${currentTab === 'roleModel3'
                    ? 'bg-purple-600 text-white shadow-md'
                    : 'text-gray-600 hover:text-purple-600'
                  }`}
              >
